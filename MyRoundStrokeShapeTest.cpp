  ...
  <Layer alias="bottom">
    <PlacedGraphic x="0" y="0">
      <VectorGraphic closed="true">
        <Stroke tip="round" size="7" color="FF0000" />
        <Point x="100" y="500" />
        <Point x="100" y="100" />
        <Point x="500" y="600" />
       </VectorGraphic>
    ...
    <PlacedGraphic x="400" y="300">
      <VectorGraphic closed="true">
        <Stroke tip="round" size="9" color="00FF00" />
        <Point x="0" y="0" />
        <Point x="0" y="100" />
        <Point x="100" y="100" />
        <Point x="100" y="0" />
  ...
  <Layer alias="top">
    <PlacedGraphic x="250" y="250">
      <VectorGraphic closed="false">
        <Stroke tip="round" size="20" color="0000FF" />
        <Point x="0" y="0" />
        <Point x="0" y="100" />
        <Point x="100" y="100" />
        <Point x="100" y="0" />
	...
	<PlacedGraphic x="600" y="650">
      <VectorGraphic closed="false">
        <Stroke tip="round" size="25" color="AA0000" />
        <Point x="0" y="0" /> 
		<Point x="100" y="0" />      
      </VectorGraphic>
    </PlacedGraphic>	
...
TEST(RoundStrokeTest, SceneReader)
{
    ...
    HProjector projector = std::make_shared<WindowsBitmapFileProjector>("output_sceneRoundStrokeShape.bmp", codecLibrary);
